function [u,posterior, out] = No_value_VBMC (data)
% // VBMC toolbox //////////////////////////////////////////////////////////
%
% OUT:
...
priors.xub = xub;
    ...
    function ll = wraper_f_No_value_VBMC(P, u, y, in)
        [ll,~]=f_No_value_VBMC(P, u, y, in);
    end


%% Parameters estimates 1st round

fun_bads=@(x) - wraper_f_No_value_VBMC(x, u, y, in);
...
fun_vbmc = @(x) wraper_f_No_value_VBMC(x, u, y, in);
...
[out.suffStat.LL, out.suffStat.gx]=f_No_value_VBMC(posterior.mean,u,y,in);
