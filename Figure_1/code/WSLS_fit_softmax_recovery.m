function [posterior, out] = WSLS_fit_softmax_recovery (data, u, y)
% // VBMC toolbox //////////////////////////////////////////////////////////
%
% OUT:
...
priors.xub = xub;
    ...
    function ll = wraper_f_WSLS_VBMC(P, u, y, in)
        [ll,~]=f_WSLS_fit_softmax(P, u, y, in);
    end
...
%Softmax must be>0
if priors.xlb_bads(9)<0.001
    priors.xlb_bads(9)=0.001;
    priors.xplb_bads(9)=0.01;
end
...
[out.suffStat.LL, out.suffStat.gx]=f_WSLS_fit_softmax(posterior.mean,u,y,in);
