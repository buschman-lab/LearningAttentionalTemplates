...
save_name='Pseudo_pop_choice_in_context_classifier';
            ...
            for i=1:length(Conditions.block_nb)-1
                ...
                for n_c=1:N_channels_stim
                    if mod(Pseudo_pop_LIP(count_LIP,i).Peak_belief,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_LIP(count_LIP,i).Peak_belief,2*pi)<n_c*2*pi/N_channels_stim
                        Pseudo_pop_LIP(count_LIP,i).Choice_context=n_c;
                    end
                end
                Pseudo_pop_LIP(count_LIP,i).Choice_context=Conditions.choice_context(i);
                %correction to get choices to be 1 2 3 in all contexts
                Pseudo_pop_LIP(count_LIP,i).Choice_in_context=Pseudo_pop_LIP(count_LIP,i).choice;
                if Pseudo_pop_LIP(count_LIP,i).Choice_context==2 && Pseudo_pop_LIP(count_LIP,i).choice==4
                    Pseudo_pop_LIP(count_LIP,i).Choice_in_context=3;
                elseif Pseudo_pop_LIP(count_LIP,i).Choice_context==3 && Pseudo_pop_LIP(count_LIP,i).choice>2
                    Pseudo_pop_LIP(count_LIP,i).Choice_in_context=Pseudo_pop_LIP(count_LIP,i).Choice_in_context-1;
                elseif Pseudo_pop_LIP(count_LIP,i).Choice_context==4
                    Pseudo_pop_LIP(count_LIP,i).Choice_in_context=Pseudo_pop_LIP(count_LIP,i).Choice_in_context-1;
                end
        ...
        for i=1:length(Conditions.block_nb)-1
            ...
            for n_c=1:N_channels_stim
                if mod(Pseudo_pop_FEF(count_FEF,i).Peak_belief,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_FEF(count_FEF,i).Peak_belief,2*pi)<n_c*2*pi/N_channels_stim
                    Pseudo_pop_FEF(count_FEF,i).Choice_context=n_c;
                end
            end
            Pseudo_pop_FEF(count_FEF,i).Choice_context=Conditions.choice_context(i);
            %correction to get choices to be 1 2 3 in all contexts
            Pseudo_pop_FEF(count_FEF,i).Choice_in_context=Pseudo_pop_FEF(count_FEF,i).choice;
            if Pseudo_pop_FEF(count_FEF,i).Choice_context==2 && Pseudo_pop_FEF(count_FEF,i).choice==4
                Pseudo_pop_FEF(count_FEF,i).Choice_in_context=3;
            elseif Pseudo_pop_FEF(count_FEF,i).Choice_context==3 && Pseudo_pop_FEF(count_FEF,i).choice>2
                Pseudo_pop_FEF(count_FEF,i).Choice_in_context=Pseudo_pop_FEF(count_FEF,i).Choice_in_context-1;
            elseif Pseudo_pop_FEF(count_FEF,i).Choice_context==4
                Pseudo_pop_FEF(count_FEF,i).Choice_in_context=Pseudo_pop_FEF(count_FEF,i).Choice_in_context-1;
            end
        end
        ...
        for i=1:length(Conditions.block_nb)-1
            ...
            for n_c=1:N_channels_stim
                if mod(Pseudo_pop_PFC(count_PFC,i).Peak_belief,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_PFC(count_PFC,i).Peak_belief,2*pi)<n_c*2*pi/N_channels_stim
                    Pseudo_pop_PFC(count_PFC,i).Choice_context=n_c;
                end
            end
            Pseudo_pop_PFC(count_PFC,i).Choice_context=Conditions.choice_context(i);
            %correction to get choices to be 1 2 3 in all contexts
            Pseudo_pop_PFC(count_PFC,i).Choice_in_context=Pseudo_pop_PFC(count_PFC,i).choice;
            if Pseudo_pop_PFC(count_PFC,i).Choice_context==2 && Pseudo_pop_PFC(count_PFC,i).choice==4
                Pseudo_pop_PFC(count_PFC,i).Choice_in_context=3;
            elseif Pseudo_pop_PFC(count_PFC,i).Choice_context==3 && Pseudo_pop_PFC(count_PFC,i).choice>2
                Pseudo_pop_PFC(count_PFC,i).Choice_in_context=Pseudo_pop_PFC(count_PFC,i).Choice_in_context-1;
            elseif Pseudo_pop_PFC(count_PFC,i).Choice_context==4
                Pseudo_pop_PFC(count_PFC,i).Choice_in_context=Pseudo_pop_PFC(count_PFC,i).Choice_in_context-1;
            end
        end
