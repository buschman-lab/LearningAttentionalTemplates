...
save_name='Pseudo_pop_peak_belief_chosen_color_classifier_2bins';
    ...
    if arrayID~=34
        ...
        for nn=1:size(data_LIP,1)
            ...
            for i=1:length(Conditions.block_nb)-1
                ...
                Pseudo_pop_LIP(count_LIP,i).chosen_color=mod(Conditions.chosen_color(i),2*pi);
                for n_c=1:N_channels_stim
                    ...
                    if mod(Pseudo_pop_LIP(count_LIP,i).chosen_color,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_LIP(count_LIP,i).chosen_color,2*pi)<n_c*2*pi/N_channels_stim
                        Pseudo_pop_LIP(count_LIP,i).Chosen_color_bin=n_c;
                    end
                end
                Pseudo_pop_LIP(count_LIP,i).chosen_value=Conditions.chosen_value(i);
                Pseudo_pop_LIP(count_LIP,i).Chosen_value_bin=(Conditions.chosen_value(i)>nanmedian(Conditions.chosen_value));
                Pseudo_pop_LIP(count_LIP,i).reward=Conditions.Reward(i);
                Pseudo_pop_LIP(count_LIP,i).Chosen_reward_bin=(Conditions.Reward(i)>nanmedian(Conditions.Reward));
            end
    ...
    for nn=1:size(data_FEF,1)
        ...
        for i=1:length(Conditions.block_nb)-1
            ...
            Pseudo_pop_FEF(count_FEF,i).Peak_belief=mod(Conditions.Peak_belief(i),2*pi);
                Pseudo_pop_FEF(count_FEF,i).chosen_color=mod(Conditions.chosen_color(i),2*pi);
            for n_c=1:N_channels_stim
                ...
                if mod(Pseudo_pop_FEF(count_FEF,i).chosen_color,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_FEF(count_FEF,i).chosen_color,2*pi)<n_c*2*pi/N_channels_stim
                    Pseudo_pop_FEF(count_FEF,i).Chosen_color_bin=n_c;
                end
            end
            Pseudo_pop_FEF(count_FEF,i).chosen_value=Conditions.chosen_value(i);
            Pseudo_pop_FEF(count_FEF,i).Chosen_value_bin=(Conditions.chosen_value(i)>nanmedian(Conditions.chosen_value));
            Pseudo_pop_FEF(count_FEF,i).reward=Conditions.Reward(i);
            Pseudo_pop_FEF(count_FEF,i).Chosen_reward_bin=(Conditions.Reward(i)>nanmedian(Conditions.Reward));
        end
    ...
    for nn=1:size(data_PFC,1)
        ...
        for i=1:length(Conditions.block_nb)-1
            ...
            Pseudo_pop_PFC(count_PFC,i).Peak_belief=mod(Conditions.Peak_belief(i),2*pi);
                Pseudo_pop_PFC(count_PFC,i).chosen_color=mod(Conditions.chosen_color(i),2*pi);
            for n_c=1:N_channels_stim
                ...
                if mod(Pseudo_pop_PFC(count_PFC,i).chosen_color,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_PFC(count_PFC,i).chosen_color,2*pi)<n_c*2*pi/N_channels_stim
                    Pseudo_pop_PFC(count_PFC,i).Chosen_color_bin=n_c;
                end
            end
            Pseudo_pop_PFC(count_PFC,i).chosen_value=Conditions.chosen_value(i);
            Pseudo_pop_PFC(count_PFC,i).Chosen_value_bin=(Conditions.chosen_value(i)>nanmedian(Conditions.chosen_value));
            Pseudo_pop_PFC(count_PFC,i).reward=Conditions.Reward(i);
            Pseudo_pop_PFC(count_PFC,i).Chosen_reward_bin=(Conditions.Reward(i)>nanmedian(Conditions.Reward));
        end
