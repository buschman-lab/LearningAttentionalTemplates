function Run_belief_classifier_combined_time_prog_rest_FEF_rotated(fsroot, ROI, n_tt, this_combination)
...
boot_name='Pseudo_pop_peak_belief_prog_classifier_bootstrap_rotated_60';
if this_combination==1
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_rotated_%s_600ms_%d',ROI,n_tt);
elseif this_combination==2
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_rotated_%s_900ms_%d',ROI,n_tt);
end
