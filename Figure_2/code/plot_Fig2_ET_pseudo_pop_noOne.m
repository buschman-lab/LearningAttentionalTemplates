...
%     save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_600ms_proj','PFC');
% elseif this_combination==2
%     save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_900ms_proj','PFC');
% end
...
for n_tt=1:100
    ...
    if this_combination==2
        results_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_900ms_%d',ROI,n_tt);
        results_NN_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_900ms_NN_%d',ROI,n_tt);
%         results_NN_each_prog_name=sprintf('Pseudo_pop_peak_belief_each_prog_combined_time_results_noOne_%s_900ms_NN_%d',ROI,n_tt);
%         results_proj_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_900ms_%d_proj',ROI,n_tt);
    end
