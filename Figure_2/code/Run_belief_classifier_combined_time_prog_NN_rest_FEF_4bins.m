function Run_belief_classifier_combined_time_prog_NN_rest_FEF_4bins(fsroot, ROI, n_tt, this_combination)
...
% boot_name='Pseudo_pop_belief_prog_classifier_bootstrap_4bins';
boot_name='Pseudo_pop_peak_belief_prog_classifier_bootstrap_4bins'; %added peak
if this_combination==1
    class_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_4bins_%s_600ms_%d',ROI,n_tt);
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_4bins_%s_600ms_NN_%d',ROI,n_tt);
elseif this_combination==2
    class_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_4bins_%s_900ms_%d',ROI,n_tt);
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_4bins_%s_900ms_NN_%d',ROI,n_tt);
end
