function Run_belief_classifier_combined_time_prog_NN_rest_FEF_noOne(fsroot, ROI, n_tt, this_combination)
...
if this_combination==1
    class_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_600ms_%d',ROI,n_tt);
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_600ms_NN_%d',ROI,n_tt);
elseif this_combination==2
    class_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_900ms_%d',ROI,n_tt);
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_noOne_%s_900ms_NN_%d',ROI,n_tt);
end
