...
for arrayID_ind=1:length(arrayID_list)
    ...
    if arrayID~=34
        ...
        null_dist_name=sprintf('null_distribution_models_FR_figure2_value_function_%s_%d','LIP',arrayID);
    ...
    null_dist_name=sprintf('null_distribution_models_FR_figure2_value_function_%s_%d','FEF',arrayID);
    ...
    null_dist_name=sprintf('null_distribution_models_FR_figure2_value_function_%s_%d','PFC',arrayID);
