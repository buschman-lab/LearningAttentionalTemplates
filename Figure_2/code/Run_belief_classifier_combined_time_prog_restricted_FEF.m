function Run_belief_classifier_combined_time_prog_restricted_FEF(fsroot, ROI, n_tt, this_combination)
...
if this_combination==1
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_more_trials_%s_600ms_%d',ROI,n_tt);
elseif this_combination==2
    save_name=sprintf('Pseudo_pop_peak_belief_prog_combined_time_results_more_trials_%s_900ms_%d',ROI,n_tt);
end
