function Run_template_classifier_combined_time_prog_NN_restricted_FEF(fsroot, ROI, n_tt, this_combination)
...
if this_combination==1
    class_name=sprintf('Pseudo_pop_true_template_prog_combined_time_results_more_trials_%s_600ms_%d',ROI,n_tt);
    save_name=sprintf('Pseudo_pop_true_template_prog_combined_time_results_more_trials_%s_600ms_NN_%d',ROI,n_tt);
elseif this_combination==2
    class_name=sprintf('Pseudo_pop_true_template_prog_combined_time_results_more_trials_%s_900ms_%d',ROI,n_tt);
    save_name=sprintf('Pseudo_pop_true_template_prog_combined_time_results_more_trials_%s_900ms_NN_%d',ROI,n_tt);
end
