...
save_name='Pseudo_pop_true_template_prog_classifier';
...
for n_sess=1:N_sessions
    ...
    if arrayID~=34 && arrayID~=30
        ...
        for nn=1:size(data_LIP,1)
            ...
            for i=1:length(Conditions.block_nb)-1
                ...
                Pseudo_pop_LIP(count_LIP,i).true_template=Conditions.rule(i+1);                
               ...
               for n_c=1:N_channels_stim
                    if mod(Pseudo_pop_LIP(count_LIP,i).true_template,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_LIP(count_LIP,i).true_template,2*pi)<n_c*2*pi/N_channels_stim
                        Pseudo_pop_LIP(count_LIP,i).True_template_color=n_c;
                    end
                end
            end
    ...
    if arrayID~=14
        ...
        for nn=1:size(data_FEF,1)
            ...
            for i=1:length(Conditions.block_nb)-1
                ...
                Pseudo_pop_FEF(count_FEF,i).true_template=Conditions.rule(i+1);                
                for n_c=1:N_channels_stim
               ...
               for n_c=1:N_channels_stim
                    if mod(Pseudo_pop_FEF(count_FEF,i).true_template,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_FEF(count_FEF,i).true_template,2*pi)<n_c*2*pi/N_channels_stim
                        Pseudo_pop_FEF(count_FEF,i).True_template_color=n_c;
                    end
                end
            end
    ...
    for nn=1:size(data_PFC,1)
        ...
        for i=1:length(Conditions.block_nb)-1
            ...
            Pseudo_pop_PFC(count_PFC,i).true_template=Conditions.rule(i+1);                
                for n_c=1:N_channels_stim
               ...
               for n_c=1:N_channels_stim
                    if mod(Pseudo_pop_PFC(count_PFC,i).true_template,2*pi)>=(n_c-1)*2*pi/N_channels_stim && mod(Pseudo_pop_PFC(count_PFC,i).true_template,2*pi)<n_c*2*pi/N_channels_stim
                        Pseudo_pop_PFC(count_PFC,i).True_template_color=n_c;
                    end
                end
        end
